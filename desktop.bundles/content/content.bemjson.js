						...
						/* Аватарки */
						{
							...
							content: [
								...
								},
								{
									...
									mods: { size: 'l' },
									mix: { block: 'decorator', mods: { 'indent-b': 'xxxl' }},
									content: 'Для отображения фотографий пользователей и может быть дополнен дополнительными элементами, такими как статус или счетчик используется { block: \'avatar\' }'
								},
								{
									elem: 'row',
									mix: { block: 'tpl-grid', mods: { ratio: '1-1-1', 'col-gap': 'half', 'row-gap': 'half' }},
